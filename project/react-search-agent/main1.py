...
def main():
    ...
    result = agent.invoke({"messages" : HumanMessage(content = "Search for latest 2 job postings (application status should not be closed) for an AI engineer using langchain in Singapore job market and list their details. ")})
    print(result)
